...
EWS.residualnoise.plasticity.0.8<-lapply(1:reps, mc.replica,tmax=800,noise.resids=0.5,
                             omega=20,beta=0.8,var.size=0.25,rho=1,var.U=1.25^2, 
                             var.Theta=1.25^2,r0=1.2,mean.breed=start.mean.breed)

save(EWS.residualnoise.plasticity.0.8, file = "EWS.residualnoise.plasticity0.8.RData")
