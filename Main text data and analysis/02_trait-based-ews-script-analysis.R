...
# this script will allow one to plot figure 4 in the main-text and figure S7 and S8.
...
for(i in 1:100){
  ...
  EWS.gen.2[i]<- list(Composite.trait.ews((genericEWS(second.op[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$ar1),
                                          (genericEWS(second.op[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$sd),
                                          (genericEWS(second.op[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
  EWS.gen.3[i]<- list(Composite.trait.ews((genericEWS(third.op[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$ar1),
                                          (genericEWS(third.op[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$sd),
                                          (genericEWS(third.op[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
  EWS.gen.4[i]<- list(Composite.trait.ews((genericEWS(fourth.op[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$ar1),
                                          (genericEWS(fourth.op[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$sd),
                                          (genericEWS(fourth.op[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
  EWS.gen.5[i]<- list(Composite.trait.ews((genericEWS(fifth.op[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$ar1),
                                          (genericEWS(fifth.op[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$sd),
                                          (genericEWS(fourth.op[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
  EWS.gen.6[i]<- list(Composite.trait.ews((genericEWS(six.op[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$ar1),
                                          (genericEWS(six.op[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$sd),
                                          (genericEWS(fourth.op[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
  EWS.gen.7[i]<- list(Composite.trait.ews((genericEWS(sev.op[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$ar1),
                                          (genericEWS(sev.op[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$sd),
                                          (genericEWS(fourth.op[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
...
# a
data.g<-data.frame(rbind(var.0.05,var.0.1, var.0.2, var.0.3,var.0.4,var.0.5),
...
#save(data.g,file="genvar.RData")

#ar1
G.trait.ar.sd2<-ggplot(var.0.05,aes(variation,Kendall.tau))+geom_boxplot(alpha=0)+ggtitle("AR1")+geom_boxplot(data=var.0.05[var.0.05$variation=="AR1+Tr",],aes(x=variation,y=Kendall.tau),fill="tomato",alpha=0.2)+
  geom_boxplot(data=var.0.05[var.0.05$variation=="AR1+SD+Tr",],aes(x=variation,y=Kendall.tau),fill="cyan",alpha=0.2)+geom_boxplot(data=var.0.05[var.0.05$variation=="SD+Tr",],aes(x=variation,y=Kendall.tau),alpha=0.2,fill="blue")+geom_jitter(alpha=0.2,width = 0.2)+ggtitle("Var= 0.05")+ylim(c(-1,1))+ylab("Kendall Tau")+xlab("Metrics")+
...
#pdf("01_TRAIT-based-EWS-genetic-var.pdf",width = 10,height = 8)
...
for(i in 1:100){ # 100 here are the no. of replicates
  
  
  EWSR0.1[i]<-list(Composite.trait.ews((genericEWS(first.R0[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$ar1),
                                       (genericEWS(first.R0[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 40)$sd),
                                       (genericEWS(first.R0[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
  EWSR0.2[i]<- list(Composite.trait.ews((genericEWS(second.R0[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$ar1),
                                        (genericEWS(second.R0[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$sd),
                                        (genericEWS(second.R0[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)                  ))
  EWSR0.3[i]<- list(Composite.trait.ews((genericEWS(third.R0[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$ar1),
                                        (genericEWS(third.R0[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$sd),
                                        (genericEWS(third.R0[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
  EWSR0.4[i]<- list(Composite.trait.ews((genericEWS(fourth.R0[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$ar1),
                                        (genericEWS(fourth.R0[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$sd),
                                        (genericEWS(fourth.R0[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
  EWSR0.5[i]<-list(Composite.trait.ews((genericEWS(fifth.R0[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$ar1),
                                       (genericEWS(fifth.R0[[i]]$N[500:530],winsize = 50,detrending = "gaussian",bandwidth = 50)$sd),
                                       (genericEWS(fifth.R0[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))

  # Kendall tau values of trait and abundance-based EWS: although mean value is taken, all the values generated from the lists below have exactly the same Kendall Tau value. For i=1 simulation of pop collapse one will get one Kendall tau value.
...
#pdf("TRAIT-based-EWS-1-R0.pdf",width = 10,height = 8)
...
for(i in 1:100){
    ...
    EWS.p.2[i]<- list(Composite.trait.ews((genericEWS(second.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$ar1),
                                          (genericEWS(second.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$sd),
                                          (genericEWS(second.p[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
  EWS.p.3[i]<- list(Composite.trait.ews((genericEWS(third.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$ar1),
                                        (genericEWS(third.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$sd),
                                        (genericEWS(third.p[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
  EWS.p.4[i]<- list(Composite.trait.ews((genericEWS(fourth.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$ar1),
                                        (genericEWS(fourth.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$sd),
                                        (genericEWS(fourth.p[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
  EWS.p.5[i]<- list(Composite.trait.ews((genericEWS(fifth.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$ar1),
                                        (genericEWS(fifth.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$sd),
                                        (genericEWS(fifth.p[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata) ))
  EWS.p.6[i]<- list(Composite.trait.ews((genericEWS(six.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$ar1),
                                        (genericEWS(six.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$sd),
                                        (genericEWS(six.p[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
  EWS.p.7[i]<- list(Composite.trait.ews((genericEWS(sev.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$ar1),
                                        (genericEWS(sev.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$sd),
                                        (genericEWS(sev.p[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)))
  EWS.p.8[i]<-list(Composite.trait.ews((genericEWS(e.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$ar1),
                                       (genericEWS(e.p[[i]]$N[500:530],winsize=50,detrending = "gaussian",bandwidth =50 )$sd),
                                       (genericEWS(e.p[[i]]$phenotype[500:530],winsize = 50,detrending = "no")$ddata)   ))
...
data.p<-data.frame(rbind(P2,P3,P4, P5,P6,P8),Plasticity =c(rep("0.05",each=600), rep("0.1", each=600),
                                                                             rep("0.2",each=600), rep("0.3",each=600), 
                                                                             rep("0.5",each=600),rep( "0.8",each=600)) )

#save(data.p,file="plasticity.RData")
...
P.trait.ar.sd2<-ggplot(P2,aes(variation,Kendall.tau))+geom_boxplot(alpha=0)+ggtitle("AR1")+geom_boxplot(data=P2[P2$variation=="AR1+Tr",],aes(x=variation,y=Kendall.tau),fill="tomato",alpha=0.2)+
  geom_boxplot(data=P2[P2$variation=="AR1+SD+Tr",],aes(x=variation,y=Kendall.tau),fill="cyan",alpha=0.2)+geom_boxplot(data=P2[P2$variation=="SD+Tr",],aes(x=variation,y=Kendall.tau),alpha=0.2,fill="blue")+geom_jitter(alpha=0.2,width = 0.2)+labs(title=(expression(paste("", b , " = 0.05 , (A)"))))+ylim(c(-1,1))+ylab("Kendall Tau")+xlab("Metrics")+
  theme_bw()+theme(plot.title = element_text(size = 14,   face = "bold"),
                   text = element_text(size = 12 ),
                   axis.title = element_text(face="bold"),
                   axis.text.x=element_text(size = 8),
...
P.trait.ar.sd3<-ggplot(P3,aes(variation,Kendall.tau))+geom_boxplot(alpha=0)+ggtitle("AR1")+geom_boxplot(data=P3[P3$variation=="AR1+Tr",],aes(x=variation,y=Kendall.tau),fill="tomato",alpha=0.2)+
  geom_boxplot(data=P3[P3$variation=="AR1+SD+Tr",],aes(x=variation,y=Kendall.tau),fill="cyan",alpha=0.2)+geom_boxplot(data=P3[P3$variation=="SD+Tr",],aes(x=variation,y=Kendall.tau),alpha=0.2,fill="blue")+geom_jitter(alpha=0.2,width = 0.2)+labs(title=(expression(paste("  ",b, " = 0.1, (B)"))))+ylim(c(-1,1))+ylab("Kendall Tau")+xlab("Metrics")+
  theme_bw()+theme(plot.title = element_text(size = 14,   face = "bold"),
                   text = element_text(size = 12 ),
                   axis.title = element_text(face="bold"),
                   axis.text.x=element_text(size = 8),
...
P.trait.ar.sd5<-ggplot(P5,aes(variation,Kendall.tau))+geom_boxplot(alpha=0)+ggtitle("AR1")+geom_boxplot(data=P5[P5$variation=="AR1+Tr",],aes(x=variation,y=Kendall.tau),fill="tomato",alpha=0.2)+
  geom_boxplot(data=P5[P5$variation=="AR1+SD+Tr",],aes(x=variation,y=Kendall.tau),fill="cyan",alpha=0.2)+geom_boxplot(data=P5[P5$variation=="SD+Tr",],aes(x=variation,y=Kendall.tau),alpha=0.2,fill="blue")+geom_jitter(alpha=0.2,width = 0.2)+labs(title=(expression(paste("",b, "= 0.4, (D)"))))+ylim(c(-1,1))+ylab("Kendall Tau")+xlab("Metrics")+
  theme_bw()+theme(plot.title = element_text(size = 14,   face = "bold"),
                   text = element_text(size = 12 ),
                   axis.title = element_text(face="bold"),
                   axis.text.x=element_text(size = 8),
...
P.trait.ar.sd6<-ggplot(P6,aes(variation,Kendall.tau))+geom_boxplot(alpha=0)+ggtitle("AR1")+geom_boxplot(data=P6[P6$variation=="AR1+Tr",],aes(x=variation,y=Kendall.tau),fill="tomato",alpha=0.2)+
  geom_boxplot(data=P6[P6$variation=="AR1+SD+Tr",],aes(x=variation,y=Kendall.tau),fill="cyan",alpha=0.2)+geom_boxplot(data=P6[P6$variation=="SD+Tr",],aes(x=variation,y=Kendall.tau),alpha=0.2,fill="blue")+geom_jitter(alpha=0.2,width = 0.2)+labs(title=(expression(paste(" ",b, "= 0.5"))))+ylim(c(-1,1))+ylab("Kendall Tau")+xlab("Metrics")+
  theme_bw()+theme(plot.title = element_text(size = 14,   face = "bold"),
                   text = element_text(size = 12 ),
                   axis.title = element_text(face="bold"),
                   axis.text.x=element_text(size = 8),
...
P.trait.ar.sd4<-ggplot(P6,aes(variation,Kendall.tau))+geom_boxplot(alpha=0)+ggtitle("AR1")+geom_boxplot(data=P6[P6$variation=="AR1+Tr",],aes(x=variation,y=Kendall.tau),fill="tomato",alpha=0.2)+
  geom_boxplot(data=P6[P6$variation=="AR1+SD+Tr",],aes(x=variation,y=Kendall.tau),fill="cyan",alpha=0.2)+geom_boxplot(data=P6[P6$variation=="SD+Tr",],aes(x=variation,y=Kendall.tau),alpha=0.2,fill="blue")+geom_jitter(alpha=0.2,width = 0.2)+labs(title=(expression(paste("  ",b, " = 0.3, (C)"))))+ylim(c(-1,1))+ylab("Kendall Tau")+xlab("Metrics")+
  theme_bw()+theme(plot.title = element_text(size = 14,   face = "bold"),
                   text = element_text(size = 12 ),
                   axis.title = element_text(face="bold"),
                   axis.text.x=element_text(size = 8),
...
P.trait.ar.sd8<-ggplot(P8,aes(variation,Kendall.tau))+geom_boxplot(alpha=0)+ggtitle("AR1")+geom_boxplot(data=P8[P8$variation=="AR1+Tr",],aes(x=variation,y=Kendall.tau),fill="tomato",alpha=0.2)+
  geom_boxplot(data=P8[P8$variation=="AR1+SD+Tr",],aes(x=variation,y=Kendall.tau),fill="cyan",alpha=0.2)+geom_boxplot(data=P8[P8$variation=="SD+Tr",],aes(x=variation,y=Kendall.tau),alpha=0.2,fill="blue")+geom_jitter(alpha=0.2,width = 0.2)+labs(title=(expression(paste(" " , b , " = 0.8, (E)"))))+ylim(c(-1,1))+ylab("Kendall Tau")+xlab("Metrics")+
  theme_bw()+theme(plot.title = element_text(size = 14,   face = "bold"),
                   text = element_text(size = 12 ),
                   axis.title = element_text(face="bold"),
                   axis.text.x=element_text(size = 8),
...
multiplot(P.trait.ar.sd2,P.trait.ar.sd3,P.trait.ar.sd4,P.trait.ar.sd5,P.trait.ar.sd8,cols=2)
#dev.off()
...
# 
# 
# data.g.midnoise<-data.frame(rbind(var.0.06,var.0.1, var.0.2, var.0.3,var.0.4,var.0.5),
#                             Genetic_variation =c(rep("0.05",each=600), rep("0.1", each=600),rep("0.2",each=600), rep("0.3",each=600), 
#                                                  rep("0.4",each=600),rep( "0.5",each=600)) , Noise_levels = "Medium_noise")
# 
# # reproductive rate data
# 
# 
# data.p.midnoise<-data.frame(rbind(P2,P3, P4, P5,P6,P8),
#                              Plasticity =c(rep("0.05",each=600), rep("0.1", each=600),rep("0.2",each=600), rep("0.3",each=600), 
#                                            rep("0.4",each=600),rep( "0.8",each=600)) , Noise_levels = "Medium_noise")
# 
# 
# 
# 
# 
# data.R.midnoise<-data.frame(rbind(R1,R2, R3, R4,R5),
#                              R0 =c(rep("1.1",each=600), rep("1.2", each=600),rep("1.3",each=600), rep("1.4",each=600), 
#                                    rep("1.5",each=600)) , Noise_levels = "Medium_noise")
# 
# 
# ## 
# datr<- read.csv(file = 'Noise levels/Reproduction_noise_low_high.csv')
# datp<- read.csv(file="Noise levels/Plasticity_noise_low_high.csv")
# datg <- read.csv(file="Noise levels/Genvar_noise_low_high.csv")
# 
# 
# datg<-datg[,-1]
# datp<-datp[,-1]
...
# 
# 
# Genvar.dat_allnoise<-data.frame(rbind(datg, data.g.midnoise))
# Plasticity.dat_allnoise<-data.frame(rbind(datp, data.p.midnoise))
# R.dat_allnoise<-data.frame(rbind(datr, data.R.midnoise))
# 
